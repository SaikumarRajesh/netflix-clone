...
const scrollRight = () => {
  ...
  return (
    ...
    <div className="flex space-x-4 overflow-x-scroll slider-container" ref={sliderRef}>
        {content.map((item) => (
            <Link to={`/watch/${item.id}`} className="min-w-[250px] relative group" key={item.id}>
                <div className="rounded-lg overflow-hidden">
                    ...
                    alt="movieimage" 
                    className="transistion-transform duration-300 ease-in-out group-hover:scale-125"
                    />
