...
const AuthScreen = () => {
  ...
  return (
    <div className="hero-bg relative">
        ...
        <Link to={"/login"} className="text-white bg-red-600 px-1 py-2 rounded">
          Sign In
        </Link>
      </header>
   ...
   <div className="py-10 bg-black text-white">
    <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
        ...
        <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl">Watch on smart TVs, Xbox, Chromecast, Apple TV, Blu-ray players, and more</p>
        </div>
        {/* right side*/}
   ...
   <div className="py-10 bg-black text-white">
    <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
        ...
        <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl">Streamed unlimited movies and TV shows on your phone, tablet, and TV.</p>
        </div>
        {/* right side*/}
    ...
    <div className="flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2">
         ...
         <div className="flex-1 relative">
            ...
            <div className="flex-1 text-center md:text-left ">
                ...
                <p className="text-lg md:text-xl">Send kids on adventures with their favorite characters in a space
